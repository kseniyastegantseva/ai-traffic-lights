...
Репозиторий реализует единый пользовательский сценарий: анализ фотографии перекрёстка
и **Модель 2: интеллектуальное управление фазами светофора**.
...
- Детектор фотографии работает внутренним модулем dashboard и не раскрывает технические
  промежуточные файлы пользователю.
